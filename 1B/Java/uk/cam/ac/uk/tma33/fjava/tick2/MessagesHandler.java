...
public class MessagesHandler {
   ...
   private static DynamicObjectInputStream mInStream;
   ...
   public MessagesHandler(OutputStream os, InputStream is) throws IOException{
      mInStream = new DynamicObjectInputStream(is);
